---
title: ModRef — International Workshop on Constraint Modelling and Reformulation
---

# International Workshop on Constraint Modelling and Reformulation

This is the archive of the **ModRef** workshop series. It collects the history of
the series and hosts a [searchable list of all past contributions](files/) with
their papers and slides.

Recent editions each have their own site (`YEAR.modref.org`), linked below. This
page supersedes the series page previously maintained at
`www-users.york.ac.uk/~af9/ModRef`, which is no longer updated; some older external
links below point to third-party pages that may no longer be available.

## Organisation

Each event has been organised by a Programme Chair and Programme Committee, who are
listed with each event. In addition, the series has been overseen by a Steering
Chair. Those serving this role are:

- 2002–2017: Alan Frisch
- 2018–2019: Kevin Leo and Alan Frisch
- 2020–present: Mateu Villaret
...
- [2024](https://2024.modref.org): The Twenty-Third International Workshop — Girona, Spain, 2 September 2024; part of [CP 2024](http://cp2024.a4cp.org/)
- [2023](https://2023.modref.org): The Twenty-Second International Workshop — Toronto, Canada, 27 August 2023; part of [CP 2023](http://cp2023.a4cp.org/)
- [2022](https://2022.modref.org): The Twenty-First International Workshop — Haifa, Israel, 31 July 2022; part of [CP 2022](http://cp2022.a4cp.org/) at [FLoC 2022](https://www.floc2022.org/)
- [2021](https://2021.modref.org): The Twentieth International Workshop — virtual, 25 October 2021; part of [CP 2021](http://cp2021.a4cp.org/)
- [2020](https://2020.modref.org): The Nineteenth International Workshop — Louvain-la-Neuve, Belgium; part of [CP 2020](http://cp2020.a4cp.org/)
- [2019](https://2019.modref.org): The Eighteenth International Workshop — Stamford, CT, USA, 30 September 2019; part of [CP 2019](http://cp2019.a4cp.org/)
...
- [CP 2001](http://www.dcs.gla.ac.uk/~pat/cp2001): Modelling and Problem Formulation
- [CP 1998](http://www.aaai.org/ojs/index.php/aimagazine/article/viewFile/1483/1382): Constraint Problem Reformulation
- Modelling and Solving Problems with Constraints (ECAI 02, IJCAI 01, ECAI 00)
